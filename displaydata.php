...
<title>ByteBooks E-Library Display Section</title>
...
<body>
		<ul>
			...
			<li><a href="https://github.com/aralukene" target="_blank">Visit My GitHub!</a></li>
		</ul>
				...
				<div class="header">
					...
					<tr>
						<?php
							...
							echo "<td><a href='http://localhost/Elibrary/files/".$row['bookname']."' download><b>Download E-Book</b></a></td>";
